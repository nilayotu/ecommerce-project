...
export default function BestSeller() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      {/* Left Category Panel */}
      <div className="w-full md:w-1/3 mt-8 md:mt-16 mb-8 md:ml-96 md:mb-16 m-4">
        <div className="relative h-full">
          <img src="/assets/furniture-1.jpg" alt="Category" className="w-full h-full object-contain" />
      ...
      <div className="w-full md:w-3/4 md:mr-96 mt-4 md:mt-16 mb-8 md:mb-16">
